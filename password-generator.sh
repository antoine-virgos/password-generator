...
######################################################################
# Generate one password or multiple passwords.
#
# Globals:
...
# Outputs:
#   Display, on the standard output, instructions about the 
#   mode selected.
######################################################################
function generate() {
...
######################################################################
function generate_one_password() {
...
######################################################################
# Grant permissions on the random passwords file generated.
#
# Globals:
#   GREEN
#   NC
...
#   None
# Outputs:
#   Display, on the standard output, a message that the permissions 
...
######################################################################
# Generate multiple random passwords with the length chose by the
...
function generate_multiple_passwords() {
    ...
    do
        ...
        # check if the password has the minimal requirements
        if test $(echo "${password}" | grep "${ALL_CHARACTERS_REGEX}")
        then
